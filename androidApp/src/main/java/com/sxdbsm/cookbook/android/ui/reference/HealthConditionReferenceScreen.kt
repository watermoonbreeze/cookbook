    ...
    Surface(color = MaterialTheme.colorScheme.background, modifier = Modifier.fillMaxSize()) {
        Scaffold(
            ...
            Column(
                ...
                InsetGroup(title = "App 怎么判断宜忌（营养数值 + 食材属性）") {
                    Para("· App 判断食材对慢病的宜忌，不只看营养数值（嘌呤 / GI / 钠 / 脂肪的毫克数），还看「食材属性」——有些食材数值不高，但因代谢机制或加工方式仍有风险。")
                    Para("· 例：啤酒嘌呤不高，但酒精抑制尿酸排泄 → 痛风仍建议避免；可乐等含糖饮料嘌呤为零，但果糖促进尿酸生成 → 痛风也应限制。这类「数值看不出的风险」由食材属性规则补上。")
                    Para("· 两者取更严：数值判「留意」而属性该「避免」的，按更严的提示。都是仅供参考、非医嘱。")
                }

                InsetGroup(title = "高血压 · 关注「钠（盐）」") {
                    Para("· 日常参考：清淡少盐、多吃蔬果。膳食指南建议每日食盐 < 5g（钠 < 2000mg）；高血压人群同样应 钠 < 2000mg（≈5g盐，2024修订版收紧，更需严格执行）。")
                    Para("· 属性风险（数值看不出的）：腌腊 / 加工肉（培根 / 香肠 / 火腿 / 腊肉）、腌制高盐（咸菜 / 腐乳 / 咸鸭蛋 / 酱菜）含大量隐形盐与亚硝酸盐，即使自己没再加盐也应避免。")
                    Para("· App 怎么用：今日营养卡按当天摄入的钠估算，偏高时提示「偏咸」；高钠及上述腌腊 / 加工食材在忌口里会标注。多钾（蔬果 / DASH 膳食方向）作正向提示，但不抵消钠、不改评级。")
                    Ref("口径参考：《中国居民膳食指南》《中国高血压防治指南》。")
                }

                InsetGroup(title = "糖尿病 · 关注「升糖（GI）」") {
                    Para("· 日常参考：少精制糖和甜食，主食尽量选低 GI（GI ≤ 55 为低、≥ 70 为高），搭配膳食纤维。")
                    Para("· 属性风险（数值看不出的）：含糖饮料（可乐等）应避免，添加糖（白糖 / 红糖 / 冰糖 / 蜂蜜）、果干等高糖食材快速升血糖，应限制——即使 GI 未标数值，高糖属性也会提示。")
                    Para("· App 怎么用：菜里含高 GI 食物时提示「可换低 GI 或控量」；上述含糖食材按属性提示避免 / 留意。膳食纤维作正向提示，与 GI 各自独立、不互相抵消。")
                    Ref("口径参考：GI 分级用 FAO/WHO 口径（我国 WS/T 652-2019 只规定 GI 测定方法、不设食物分级）；限添加糖 / 含糖饮料据《中国 2 型糖尿病防治指南》《成人糖尿病食养指南（2023）》。")
                }

                InsetGroup(title = "痛风 / 高尿酸 · 关注「嘌呤」") {
                    Para("· 日常参考：急性期避免高嘌呤食物（动物内脏、浓肉汤、部分海鲜如沙丁鱼等），多喝水、限酒。")
                    Para("· 属性风险（数值看不出的）：酒类——啤酒 / 白酒 / 黄酒 / 米酒等酒精抑制尿酸排泄，建议避免，葡萄酒限制；含糖饮料、添加糖、果干（可乐、白糖 / 红糖、葡萄干等）——果糖促进尿酸生成、独立于嘌呤，应限制。")
                    Para("· 新鲜水果可正常适量吃：虽含果糖，但维 C / 钾 / 膳食纤维改变了果糖对尿酸的影响，指南指出「水果摄入量与痛风无显著相关」，建议每天约 200～350g；樱桃、草莓等富含维 C 的水果还有助降尿酸。（限的是含糖饮料 / 果汁 / 果葡糖浆 / 果脯蜜饯这类加工浓缩果糖，不是新鲜水果。）")
                    Para("· App 怎么用：菜里含高嘌呤食物时给「建议避免」的定性提示（不做精确毫克计算）；酒类 / 含糖饮料 / 添加糖 / 果干即使嘌呤数值低，也按属性提示避免 / 留意；新鲜水果不做痛风忌口。")
                    Ref("口径参考：《WS/T 560-2017 高尿酸血症与痛风患者膳食指导》《成人高尿酸血症与痛风食养指南（2024·卫健委）》（蔬奶充足、限制果糖：限含糖饮料 / 果汁 / 果葡糖浆 / 果脯蜜饯；新鲜水果适量、与痛风无显著相关）。注：嘌呤「高 / 中 / 低」的具体毫克阈值无国家标准，本 App 用惯例定性、非权威分级。")
                }

                InsetGroup(title = "高血脂 · 关注「饱和脂肪、胆固醇、反式脂肪」") {
                    Para("· 日常参考：少油腻和肥肉、少动物油，控制高胆固醇食物（如动物内脏，蛋黄适量），多膳食纤维。")
                    Para("· 属性风险（数值看不出的）：反式脂肪（植脂末 / 奶精 / 氢化植物油 / 起酥点心）升高低密度脂蛋白胆固醇、增加心血管风险，营养成分表常查不到，按食材属性提示避免。")
                    Para("· App 怎么用：菜的饱和脂肪或胆固醇偏高时提示「留意」；含反式脂肪的加工食材按属性提示避免。（部分食材数据仍在陆续补齐中。）")
                    Ref("口径参考：《中国血脂管理指南（2023）》《中国居民膳食指南》。一般参考：每日饱和脂肪约占能量 < 10%（≈20g）、胆固醇 < 300mg，反式脂肪供能 < 1%、尽量避免。")
                }

                // [AI修改] L2：脂肪肝仅复用既有食材级 care 规则，不新增诊断、数值阈值或治疗建议。
                InsetGroup(title = "非酒精性脂肪肝 · 食材级饮食参考") {
                    Para("· App 只在你已登记该健康状态时，按既有食材级规则提供避免 / 限量 / 推荐参考；它不参与诊断，也不替代个体化饮食方案。")
                    Para("· 以上内容仅供参考、非医嘱。饮食安排请咨询医生，并遵医嘱。")
                    Ref("参考口径：App 既有食材级分类参考；具体食材规则来源请以条目为准。")
                }

                InsetGroup(title = "备孕 · 关注「提前补叶酸 / 铁 / 碘」") {
                    Para("· 多吃方向：孕前 3 个月起多吃深绿叶菜（叶酸）、瘦红肉（铁）配维 C 蔬果促吸收、加碘盐和海产（碘）、奶蛋豆制品，调整到适宜体重。")
                    Para("· 要避开 / 限：戒烟酒；动物肝维生素 A 高、限量别多吃；少浓茶咖啡、少高盐腌制。")
                    Ref("口径参考：《中国居民膳食指南（2022）·备孕妇女》。备孕与孕产请遵医嘱 / 产科医生。")
                }
