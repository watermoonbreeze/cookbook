...
val androidModule = module {
    ...
    viewModel { (initialText: String, targetDate: kotlinx.datetime.LocalDate) -> com.sxdbsm.cookbook.android.ui.ai.AiMealInputViewModel(initialText, targetDate, get(), get(), get(), get()) }
}
