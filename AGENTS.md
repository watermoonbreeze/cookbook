...
- **项目全景图（首读）**：`.ai-context/docs/projectReview/00_导读与索引.md` —— 本项目整体架构、方向、主流程、页面流转、算法、数据、AI/网络、参考资料与预设治理的唯一地图。凡任务涉及上述任一全局关联内容，**先读本册并按阅读路径下钻**；实质改动后，同任务维护受影响分册、`05_诊断地图.md` 与 `.ai-context/docs/功能路径索引.md`。
