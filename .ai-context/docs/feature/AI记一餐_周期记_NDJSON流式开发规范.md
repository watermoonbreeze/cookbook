...
| B2 Runtime ✅ | `AiRuntime.stream`、DeepSeek SSE、finish reason、整包模拟流 fallback、脱敏日志 | Runtime 单测/Mock 测试；HTTP 实现不含餐食语义 | 2026-08-05: GlmProtocol SSE 解析 6 测试 + stream body 3 测试 0 失败 |
