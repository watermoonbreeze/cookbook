...
> 当前状态：AI 记一餐 V2 追加验证通过；周期记 + NDJSON 流式大改的 B1/B2 二审仍不通过，须先完成 AF-06 至 AF-09（以及未关闭的 AF-01 至 AF-05），B3 被阻断。
...
> 2026-08-05 架构基线已补齐：实施必须先读 `feature/AI记一餐_周期记_NDJSON流式开发规范.md`，按 B1 至 B6 分批交付；当前无老版本，禁止旧协议兼容、数据迁移与双轨状态。B1/B2 的复审反馈在 `feature/AI记一餐_周期记_NDJSON流式改造落地方案.md` 第七节，AF-01 至 AF-05 未关闭前不得开始 B3。
