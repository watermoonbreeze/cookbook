...
> **④ 属性风险care首批(用户洞察·忌口=数值+食材属性双层·参照啤酒机制)**：可乐等含糖/高果糖食材嘌呤=0纯数值判可食,但果糖升尿酸(独立于嘌呤)→已补痛风care_gout limit×14+糖尿病×6(可乐avoid)·保守limit·带痛风/糖尿病指南ref·care584→604·单测过·push·数据来源页依据已补。**交用户审level/范围**(高果糖水果荔枝/香蕉/芒果/西瓜是否该care·番茄酱/甜面酱调味品是否补)·范式认可后系统铺开反式脂肪/高胆固醇/高草酸类。方法论+框架见 `属性风险care补漏.md`。
>
