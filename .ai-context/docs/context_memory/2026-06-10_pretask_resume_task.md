...
- 预计涉及文件/模块：`shared/src/commonMain/sqldelight/`、`shared/src/commonMain/kotlin/com/sxdbsm/cookbook/data/repository/`、`shared/src/androidUnitTest/`、`.ai-context/docs/context_memory/`。
