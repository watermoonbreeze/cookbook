...
- 已知项目状态：KMP 项目，Android UI 在 androidApp，shared 承担 Domain/Data；需遵循 AGENTS.md 与 `.ai-context/docs/experience/09_工程统一规范.md`。
- 预计涉及文件/模块：`androidApp` 首页、导航、主题设置、Mine 页面；`shared` meal/dish/history 相关 repository/usecase/schema；`docs` 与 `.ai-context/docs/feature` MVP 文档。
