...
### ⚠️ 待确认队列（用户回来定）
- **忌口-Q1 植物高嘌呤"数值判红 vs 规则不忌口"冲突**：黄豆(purine190)/干香菇(214) 数值层≥150 被 `NutritionLevelEvaluator` 判红(痛风慎选)，但《成人高尿酸血症与痛风食养指南2024》明确植物嘌呤利用率低、不增痛风风险→**不该忌口**。冲突根因=数值层不分动植物来源。**需人工裁决**：是否对"植物来源高嘌呤"在数值层做例外(改算法·风险中)或加提示文案"植物嘌呤影响小"。涉数值层逻辑+健康口径决策·无人值守不自主改。
- **忌口-Q2 鱼油高血脂 recommend**：omega-3 降甘油三酯是"处方级制剂"结论·市售鱼油保健品≠处方·写"推荐/降脂"踩健康免责红线→暂不加 recommend。待用户定是否加(或只作中性说明)。
- **忌口-Q3 鸡毛蛋 preschool/lactation**：风险方向同孕婴但无针对性指南原文点名·保守未加(只加了 pregnancy/infant=avoid)。待定是否参孕婴口径补 limit/avoid。
- **GI-Q4 面米主食 GI 真缺口**：速冻馒头/包子/小笼包/粘米粉/八宝粥/手抓饼/坚果麦片/酒酿等缺 GI(碳水≥15)。标准主食(馒头/米粉)有权威近似GI可少量联网补·复合食品(小笼包/手抓饼)无标准GI宜留空。属"可选后续少量联网核准"·非大批量·未在本轮硬做。
