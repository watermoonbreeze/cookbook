...
class LoggerTest {
    ...
    fun businessTraceEmitsActionNavigationAndScreenWithOneTraceId() {
        ...
        BusinessTrace.navigationStarted("home", "ai_recommend", traceId)
        BusinessTrace.navigationCompleted("home", "ai_recommend", traceId)
        BusinessTrace.screenEntered("ai_recommend", traceId)
        BusinessTrace.screenLoaded("ai_recommend", traceId)
