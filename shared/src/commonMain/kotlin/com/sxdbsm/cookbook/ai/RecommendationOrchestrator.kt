...
class RecommendationOrchestrator(
    ...
    suspend fun recommend(
        ...
        // [AI生成] 诊断日志(仅 debug 开关开启时构造)：规则评估后按分数降序的候选(名#id(分))，看某道菜是否进候选、排第几。
        com.sxdbsm.cookbook.platform.CookbookDiag.log("PantryRec") {
        ...
        com.sxdbsm.cookbook.platform.CookbookDiag.log("PantryRec") {
            "==⑤ 本批展示(rotation=$rotation 取前${DISPLAY_BATCH}): " + candidates.take(DISPLAY_BATCH).joinToString("、") { it.name }
        }
